...
switch ($request) {
    ...
    case '/admin/enable-addon':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->enableAddon();
        break;
        
    case '/admin/disable-addon':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->disableAddon();
        break;
        
    case '/admin/install-addon':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->installAddon();
        break;
        
    case '/admin/uninstall-addon':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
    ...
    case '/admin/set-active-theme':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->setActiveTheme();
        break;
        
    case '/admin/update-theme-settings':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->updateThemeSettings();
        break;
        
    case '/admin/install-theme':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->installTheme();
        break;
        
    case '/admin/uninstall-theme':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->uninstallTheme();
        break;
    ...
    case '/admin/create-database-backup':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->createDatabaseBackup();
        break;
        
    case '/admin/create-files-backup':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->createFilesBackup();
        break;
        
    case '/admin/create-complete-backup':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->createCompleteBackup();
        break;
    ...
    case '/admin/export-settings':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->exportSettings();
        break;
        
    case '/admin/import-settings':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
        $controller->importSettings();
        break;
        
    case '/admin/reset-settings':
        require_once LUNA_DINE_CORE . '/controllers/AdminController.php';
        $controller = new AdminController($db, $auth);
